...
class CatchupKeyPolicyTest {
    private val back = CatchupCommand.Seek(-CatchupKeyPolicy.SKIP_BACK_MS)
    private val forward = CatchupCommand.Seek(CatchupKeyPolicy.SKIP_FORWARD_MS)
    private val rewindLive = CatchupCommand.RewindLive(CatchupKeyPolicy.SKIP_BACK_MS)
