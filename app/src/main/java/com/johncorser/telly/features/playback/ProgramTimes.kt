 ...
 * bare-TimeZone overloads keep the 12-hour rendering for the reminders,
 * recording and My-list slices, which are owned elsewhere (search and
 * multiview honor the persisted style).
 */
object ProgramTimes {
    ...
    fun clock(
        atMs: Long,
        zone: TimeZone,
    ): String = clock(atMs, ClockStyle(zone))
