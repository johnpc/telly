...
class PlaybackViewModel(
    ...
    private val tuner = TuneController(env.engine, env.store, scope, env.channelDao, history, hooks.external)
    ...
    init {
        ...
        feedFrameRates(video, scope, hooks.onFrameRateChanged)
    }
