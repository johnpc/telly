 ...
 * column is 540 px = 270 dp wide and rows repeat at 78 px = 39 dp pitch.
 */
object GuideGeometry {
    ...
    /** Channel column width: cells start at x=540 px in uidumps 24/25. */
    const val CHANNEL_COLUMN_DP = 270f

    /** 78 px row pitch (uidump 24 channel rows). */
    const val ROW_HEIGHT_DP = 39f

    /** Time viewport on the 960 dp reference screen: 1920-540 px = 690 dp. */
    const val TIME_VIEWPORT_DP = 690f
