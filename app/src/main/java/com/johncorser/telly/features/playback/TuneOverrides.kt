 ...
 * [streamUrl] is the RESOLVED live URL (UDP-proxy rewrite already applied).
 */
internal fun ExternalPlayer.handsOff(
    channel: ChannelEntity,
    streamUrl: String,
): Boolean = maybeLaunch(streamUrl, ExternalPlayerSetting.overrideOf(channel.overrides.externalPlayer))
